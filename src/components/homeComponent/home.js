      ...
      <div className="grayContainer">
        <div className="jumbo">
          {isLogged ? (
            <div className="image">
              <img src={userImage} />
              <h1 className="jumboTitle">Hi {userName}!</h1>
            </div>
          ) : (
          ...
          <div className="jumboDesc">
            <p>
              Color really isn't that difficult to get right, if you know where
              to start.
              <br />
      ...
      <div className="displayCard">
        <div className="card">
          <div className="container">
            <img
              className="cardImg"
              src={require("../../Assets/images/pane-1-icon.png")}
              alt="Blue Icon"
            />
            ...
            <div className="card-body">
              <p>
                ...
                with depth and stability. It symbolizes trust, loyalty, wisdom,
                confidence, and intelligence, faith, truth, and heaven.
              </p>
            </div>
          </div>
        </div>
        <div className="card">
          <div className="container">
            <img
              className="cardImg"
              src={require("../../Assets/images/pane-2-icon.png")}
              alt="Green"
            />
            ...
            <div className="card-body">
              <p>
                ...
                freshness, and fertility. Green has a strong emotional
        ...
        <div className="card">
          <div className="container">
            <img
              className="cardImg"
              src={require("../../Assets/images/pane-3-icon.png")}
              alt="Red"
            />
